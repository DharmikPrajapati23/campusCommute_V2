...
// ✅ AppRoutes only contains Routes — no BrowserRouter here
// useNavigate works because BrowserRouter is its parent in App
const AppRoutes = () => {
  const navigate = useNavigate(); // ✅ Safe — BrowserRouter is above this
...
// ✅ BrowserRouter wraps AppRoutes — Router context exists before hooks run
const App = () => (
