...
const Login = () => {
  ...
  // ✅ Handle login — store token + user in localStorage
  const handleLogin = async () => {
    ...
    try {
      ...
      // Store auth token and user persistently
  ...
  const handleSignUp = async () => {
    ...
    try {
      ...
      if (res.data.message === "OTP sent to email") {
        // Temp signup token for OTP verification
  ...
  // ✅ Handle OTP verify — store auth token + user, remove temp signup_token
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      // Replace temp signup token with real auth token
        ...
        <div className="md:w-1/2 flex flex-col justify-center px-2">
            ...
            <>
              ...
              <div className="flex justify-between items-center mb-3 px-1">
                <span className={`text-sm ${canResendOtp ? "text-green-600" : "text-gray-600"}`}>
                  {canResendOtp ? "You can resend the OTP." : `Resend OTP in ${otpTimer}s`}
                </span>
                {canResendOtp && (
                  <button
          ...
          {!showOtpInput && (
            <button
              ...
              className="w-full py-3 rounded-lg font-bold mt-2 shadow transition bg-gray-800 hover:bg-gray-600 text-white"
              disabled={loading}
            >
          ...
          <button
            ...
            onClick={() => {
              ...
              setError("");
              setSuccess("");
              setFormData({ enrollment: "", password: "", email: "", name: "", otp: "" });
            }}
          >
